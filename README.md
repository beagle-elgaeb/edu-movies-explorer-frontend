...
:small_red_triangle: чтобы скрыть `Header` (на страницах решистрации и авторизации) необходимо нажать `Ctrl + X`;  
:small_red_triangle: для демонстрации прелоадера необходимо нажать кнопку поиска на странице с фильмами (кнопка на 3 секунды меняется на прелоадер, а фильмы скрываются);  
